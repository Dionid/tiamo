...
export type LoginByPasswordlessCodeResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['LoginByPasswordlessCodeResponse'] = ResolversParentTypes['LoginByPasswordlessCodeResponse']> = {
  token?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType>;
};

export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  registerUser?: Resolver<Maybe<ResolversTypes['MutationResponse']>, ParentType, ContextType, RequireFields<MutationRegisterUserArgs, never>>;
  approveEmailByToken?: Resolver<Maybe<ResolversTypes['MutationResponse']>, ParentType, ContextType, RequireFields<MutationApproveEmailByTokenArgs, never>>;
  requestPasswordlessCodeByEmail?: Resolver<Maybe<ResolversTypes['MutationResponse']>, ParentType, ContextType, RequireFields<MutationRequestPasswordlessCodeByEmailArgs, never>>;
  loginByPasswordlessCode?: Resolver<Maybe<ResolversTypes['LoginByPasswordlessCodeResponse']>, ParentType, ContextType, RequireFields<MutationLoginByPasswordlessCodeArgs, never>>;
};
